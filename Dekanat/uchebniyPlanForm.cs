...
namespace Dekanat
{
    public partial class uchebniyPlanForm : Form
    {
        public uchebniyPlanForm()
        {
            InitializeComponent();
        }

        private void uchebniyPlanForm_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                sqlCommand1.Parameters["@abbreviatura"].Value = $"{comboBox1.Text.Trim()}";
